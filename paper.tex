...
The object \deff{regex} is an abstraction of a regular expression, in accordance with \citet[Part~2]{posix} (Extended Regular Expressions) and full support of Unicode. The attribute \deff{matched} is a split of the \ff{string} into parts:
