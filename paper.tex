...
In this paper\footnote{Version \href{https://github.com/REPOSITORY/releases/tag/0.0.0}{\ff{0.0.0}}}
we don't provide exact specification of each object, in order to avoid conflicts with their exact definitions in Objectionary\footnote{\url{https://www.objectionary.com}}.
