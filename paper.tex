...
The attribute \adeff{concatted} is a new sequence, which is a concatenation of two byte sequences: the current and the provided one.
...
\begin{itemize}
    ...
    \item \deff{splitted}: breaks it into an array of strings
